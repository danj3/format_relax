defmodule Mix.Tasks.FormatRelax do
  use Mix.Task

  @shortdoc "Formats the given files/patterns with relaxed spacing"
  ...
  defp format_file( { file, formatter_opts }, task_opts ) do
    ...
    output =
      IO.iodata_to_binary( [ 
        RelaxedCodeFormat.format_string!( input, extra_opts ++ formatter_opts ),
        ?\n
      ] )
